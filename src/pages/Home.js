    ...
    return(
        <div>
                    ...
                    <div className="container">
                        <div className="section--hero__contents">
                            <h1 className="heading-1">
                                <span style={{fontWeight: 500}}>你也同樣</span>
                                <span style={{fontWeight: 700}}>飄忽不定</span>
                                <span style={{fontWeight: 500}}>嗎？</span>
                
                                <br />

                                <span style={{fontWeight: 500}}>給同樣</span>
                                <span style={{fontWeight: 700}}>飄忽不定</span>

                                <br />

                                <span style={{fontWeight: 500}}>的你.</span>
                            </h1>
                        ...
                        <p className='heading-3'>說不定你就能成為人生中的大王</p>
                    </div>                    
                </FadeInSection>
            </section>
            ...
            <section class="section section--about" id="about">
                ...
                <div class="container"><div class="section--about__content">
            ...
            <section class="section section--services">
                ...
                <div class="container"><div class="section--services__content">
                    <FadeInSection>
                        <FoldableCard_2 
                            title="網站設計"
                            title_EN="Web Design"
            ...
            <section className='section section--blank'>
                <div className='contaienr'>
                    <h2 className='section--blank__content heading-1'>
                        <span>讓我們</span>
                        <br/>
                        <span>變得</span>
                        <span className='orange'>更好</span>
                    </h2>
                </div>
            ...
            <section class="section section--portfolio" id="portfolio">
                ...
                <div class="container"><div class="section--portfolio__content">
                    {/* tabs labels */}
                    <FadeInSection>
